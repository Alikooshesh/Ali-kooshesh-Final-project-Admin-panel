...
import {RdashboardRoutes} from "../../Routes/RdashboardRoutes";
    ...
    return (
        <div className={classes.root}>
            ...
            >
                ...
                <List>
                    ...
                    <ListItem onClick={()=> history.push('/dashboard/orders')} style={{cursor : 'pointer'}}>
                        <ListItemIcon> <InboxIcon /> </ListItemIcon>
                        <ListItemText color={'secondary'} primary={'Orders List'} />
                    </ListItem>

                    <ListItem onClick={()=> history.push('/dashboard/users')} style={{cursor : 'pointer'}}>
                        <ListItemIcon> <InboxIcon /> </ListItemIcon>
                        <ListItemText color={'secondary'} primary={'Users List'} />
                    </ListItem>
                </List>
                <Divider />
                <List>
                    <ListItem onClick={()=> dispatch(logout())} style={{cursor : 'pointer'}}>
                        <ListItemIcon> <InboxIcon /> </ListItemIcon>
            ...
            <main className={classes.content}>
                <div className={classes.toolbar} />
                <Switch>
                    {RdashboardRoutes.map((item , index) => {
